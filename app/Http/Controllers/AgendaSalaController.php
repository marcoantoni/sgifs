...
class AgendaSalaController extends Controller {
    ...
    public function index() {
        ...
        $agendamentos = AgendaSala::getReservas($data_inicial); //'dia', '>=', $data_inicial)->get();
    ...
    public function create() {
      ...
      return view('agenda_sala.create')->with(['salas' => $salas, 'pgtitulo' => 'Novo agendamento de sala']);
    }
    ...
    public function edit($id) {
      ...
      if ($agenda->id_user == Auth::User()->id){
        $salas = Sala::orderBy('nome', 'ASC')->get();
        return view('agenda_sala.edit')->with(['agenda' => $agenda, 'salas' => $salas, 'pgtitulo' => 'Editando agendamento de sala/laboratório']); 
      } else {
