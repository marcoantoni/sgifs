...
@section('content')
<h1 class="ls-title-intro ls-ico-stats">Resumo da execução orcamentária</h1>
@if (session('success'))
  <div class="ls-alert-success ls-dismissable" id="alert-successss">
...
<div class="ls-box-filter">
  <form action="javascript:redirectToOrcamento();" class="ls-form ls-form-inline ">
...
<table class="ls-table ls-sm-space ls-table-layout-auto" id="myTable">
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <tr @if ($empenho->cancelado == 1) class="cancelado"  @endif>
      <td>{{ $empenho->numero }} @if ($empenho->cancelado == 1) <span class="ls-tag-danger">Cancelado</span>  @endif </td>
